...
export function renderScenario() {
  ...
  for (const card of handCards) {
    ...
    let badge = '';
    if (locked) badge = `<span class="ex-badge ex-badge-locked" aria-hidden="true">🔒</span>`;
    else if (added) badge = `<span class="ex-badge ex-badge-added" aria-hidden="true">+</span>`;
    else if (emphasized) badge = `<span class="ex-badge ex-badge-emphasized" aria-hidden="true">★</span>`;
