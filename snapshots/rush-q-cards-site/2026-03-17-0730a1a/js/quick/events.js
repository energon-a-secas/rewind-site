...
window._showCardDetail = function(cardId) {
  ...
  modal.innerHTML = `<div class="modal-content">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px">
      ...
      <button class="btn btn-sm" onclick="document.getElementById('modal').classList.add('hidden')">✕</button>
    </div>
...
window._showCommitModal = function(projectId) {
  ...
  modal.innerHTML = `<div class="modal-content">
    ...
    <p style="font-size:var(--text-sm);color:var(--text-secondary)">
      Needs: &#128100; ${needed} people${sqCost ? ` + &#9724; ${sqCost} squares` : ''} &middot; Reward: ${project.reward || 0} rep
    </p>
...
const TUTORIAL_STEPS = [
  ...
  { title: 'Budget Cards', text: 'Triangles hire people. Squares pay project costs. Budget cards expire after your next turn — watch for the red "Expires" label!' },
