...
const SUBPAGE_SEGMENTS = [
  ...
  'exercises', 'simulation', 'faq', 'history', 'starter', 'behavior',
  'perspectives', 'facilitator', 'table-talk', 'room',
];
...
const MORE_GROUPS = [
  {
    label: 'Learn',
    items: [
      { route: '/perspectives/', label: 'Perspectives' },
  ...
  },
  {
    label: 'Play',
    items: [
      { route: '/starter/', label: 'Starter Mode' },
    ],
  },
];
