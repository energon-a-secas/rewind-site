// Copyright (c) 2026 Luciano Adonis. MIT License (code) — see LICENSE.
// Game content is proprietary — see LICENSE.CONTENT.
//
// GENERATED by scripts/generate-icons.mjs — do not edit by hand.
// Icons: Lucide (https://lucide.dev) — ISC License.
// Shared SVG icon registry: every visual symbol on the site comes from here.
...
// emoji → icon name, so legacy data (cards.json `emoji` field) needs no migration
...
/**
 * Inline SVG for a legacy emoji glyph (card art, person markers).
 * Unknown emojis fall back to the generic card-back icon.
 */
