...
export function showTutorial(mode = 'classic') {
  // One teacher at a time — a coach-mark racing the tutorial to the screen
  // wins on timing, not on usefulness.
  import('./hints.js').then((m) => m.suspendHints()).catch(() => {});
