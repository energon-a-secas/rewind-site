...
// soften it, and do not annotate it with what third-party banks ask
// anyway. Bank-only material belongs in data/traps/, which renders it
// with the "Beyond the guide" badge.
//
// Escaping: every field here is plain text and goes through escHtml.
...
export const EXAM_BRIEF = {
  ...
  outOfScope: [
    ...
    'Embedding model and vector database internals; the practice test still uses them as distractor options.',
