  ...
  sides: [
    {
      id: 'prompt',
      tone: 'warn',
      title: 'Steer with the prompt — the loop decides',
...
# follows most of the time - no guarantee`,
    ...
    },
    {
      id: 'code',
      tone: 'ok',
      title: 'Enforce in code — the runtime decides',
...
def enforce_refund_limit(call):
    ...
    return call`,
      rel: { tone: 'ok', text: 'Deterministic. The hook fires 100% of the time — it runs in code, not in the prompt.' },
    },
  ],
