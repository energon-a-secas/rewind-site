(function () {
  ...
  const CATEGORIES = [
    ...
    { label: 'DevOps',        color: '#fbbf24', ids: ['cardforge','infradrills','snippets','lockdown','runbook'], keywords: 'devops challenges cli cheatsheet search aws kubernetes docker k8s shell infra drills snippets lockdown security scanner endpoints headers incident runbook alert response on-call checklist cardforge card designer editor json export rush q game builder' },
    { label: 'Data',          color: '#2dd4bf', ids: ['jsonstudio','references','sitrep'], keywords: 'data editor privacy api search json reference matrix scrambler viewer visualizer sitrep santiago chile earthquakes seismic weather forecast metro transit war room situation board dashboard usgs' },
