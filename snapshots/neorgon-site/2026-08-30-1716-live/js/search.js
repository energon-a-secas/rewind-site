(function () {
  ...
  const CATEGORIES = [
    ...
    { label: 'Fun',           color: '#f472b6', ids: ['decisionwheel','memes','clientsays','emojis','teamplay','gamebin','minimap','youtube','pixeldoll'], keywords: 'pixeldoll pixel character avatar builder sprite dress up wardrobe unlockables cookie floorplan minimap arpg parody dungeon boss grind level fun randomizer community upload wheel spin memes timezone translator jargon client says decoded emoji archive search gamebin game bin steam lists curate profile youtube video overflow pieza dice cards tabletop print play boss hunt dnd bilingual card game teamplay team building retros activities icebreakers games strategy' },
    { label: 'Social',        color: '#38bdf8', ids: ['dispatch','vibecheck','hiringpack','charactersheet','parla','playbook','tubestack'], keywords: 'dispatch antenne news fleet feed changelog release notes launches updates stories headlines rss desk approval whats new social interviews scoring vibe check behavioral personality export character sheet know parla slang latin american regional language playbook career advice tech job hunting bilingual english spanish tubestack youtube channels discovery engineers match community hiring pack resume bullets follow-up' },
