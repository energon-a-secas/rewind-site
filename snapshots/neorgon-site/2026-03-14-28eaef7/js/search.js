(function () {
  ...
  const CATEGORIES = [
    ...
    { label: 'Productivity',  color: '#a78bfa', ids: ['slides','ogstudio','resume-forge'], keywords: 'productivity slides export audit presentation sage yaml pptx marp og preview design generator studio resume forge gaming pdf psn steam' },
